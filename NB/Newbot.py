...
def display_conversation(conversation_id, store_id):
    ...
    if conversation_data:
        ...
        query_params = urlencode({'conversation_id': conversation_id, 'store_id': store_id})
        current_page_url = f"{base_url['page']}?{query_params}"
        st.write(f'[View this conversation here]({current_page_url})')
...
def main():
    ...
    # Sidebar navigation
    page = st.sidebar.radio('Go to', ['Home', 'View Conversation'])
